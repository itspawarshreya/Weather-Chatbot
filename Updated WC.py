...
def get_weather(city):
    try:
        ...
        if data['cod'] == 200:
            ...
            # Perform sentiment analysis on the weather description
            sentiment = sia.polarity_scores(weather_desc)['compound']
            ...
            return f"The weather in {city} is {weather_desc}. The temperature is {temp_celsius}°C. Sentiment: {sentiment_label}"
        else:
